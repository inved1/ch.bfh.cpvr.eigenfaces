...
for i=1:length(imgstats)
    ...
    disp(imgstats(i).MajorAxisLength);
    disp(imgstats(i).MinorAxisLength);
    disp(imgstats(i).MajorAxisLength / imgstats(i).MinorAxisLength);
    if ((imgstats(i).MajorAxisLength / imgstats(i).MinorAxisLength) < 2.8)
...
foundFaces = foundFaces(~cellfun('isempty',foundFaces));
% PCA
